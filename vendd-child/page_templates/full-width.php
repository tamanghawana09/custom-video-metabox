        ...
        <main id="full-width-page-main" class="full-width-page-site-main" role="main">
            ...
            <?php while (have_posts()) : the_post(); ?>
                ...
                <section id="post-<?php the_ID(); ?>" <?php post_class('full-width-page-section'); ?>>
                    ...
                    <?php
                    elseif (has_post_thumbnail() && 1 == get_theme_mod('vendd_page_featured_image', 0)) :
                        the_post_thumbnail('vendd_featured_image_full_width', array('class' => 'featured-img
                    featured-img-full-width'));
